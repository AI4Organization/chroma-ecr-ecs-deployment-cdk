 ...
 * @param {ChromaDockerImageEcsDeploymentCdkStackProps} props - Properties for VPC creation.
 * @returns {ec2.Vpc} The created VPC.
 */
export function createVPC(stack: cdk.Stack, props: ChromaDockerImageEcsDeploymentCdkStackProps): ec2.Vpc {
